  ...
  <Popover class="relative bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <button class="px-1 py-1 cursor-pointer" @click="$emit('toggleDark')" style="background: transparent; border: none;">
            <div v-if="dark"><MoonIcon class="h-10 w-10" /></div>
            <div v-else><SunIcon class="h-10 w-10" /></div>
        </button>
      </div>
    </div>
...
import { SunIcon, ChevronDownIcon } from '@heroicons/vue/solid'
